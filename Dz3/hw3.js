...
// Вывести в консоль умножение item_3 и item_4 (результат NaN, можно ли по другому не нашла)
console.log(item_3 * item_4)
// Создать переменную item_5
let item_5
// Присвоить переменной item_5 переменную item_3
item_5 = item_3
// Создать переменные item_6 и  item_6_type
let item_6
let item_6_type
...
let item_7_type
//Присвоить переменной item_7_type
